-- Add SettingSync to the Tools menu in File Manager, after cloud storage item
...
table.insert(filemanager_order.tools, pos, "settingsync")
...
table.insert(reader_order.tools, pos, "settingsync")
